export const JS_Shortcuts_rg_move_copy = {
  "properties": {
    "condition": {
      "next": {
        "next": {
          "args": "rg_Next rg-shortcuts",
          "next": {
            "args": {
              "next": {
                "next": {
                  "args": "rg_Prev rg-shortcuts",
                  "type": "Message",
                  "name": "contains",
                  "is_slidable": false
                },
  ...
  "id": "bTvGV1",
  "name": "JS Shortcuts rg_move (copy)",
  "actions": {
    "0": {
      "properties": {
        "value": {
          ...
          "next": {
            "next": {
              ...
              "properties": {
                "separator": {
                  "entries": {
                    "0": "rg_Next rg-shortcuts arrowIndex="
                  },
                  "type": "TextExpression"
                }
              },
