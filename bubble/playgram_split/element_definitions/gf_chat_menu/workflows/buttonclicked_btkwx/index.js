export const ButtonClicked_bTKwx = {
  "properties": {
    "element_id": "bTKtO0"
  },
  "type": "ButtonClicked",
                  ...
                  "properties": {
                    "arbitrary_text": {
                      "entries": {
                        ...
                        "4": "\\\" }, { operator: Or, operands: [ { path: [\\\"image\\\"], operator: IsNull, valueBoolean: false }, { path: [\\\"user_image\\\"], operator: IsNull, valueBoolean: false } ] } ] }) { image user_image _additional { id } } } }\"}"
                      },
                      "type": "TextExpression"
                    }
                  },
