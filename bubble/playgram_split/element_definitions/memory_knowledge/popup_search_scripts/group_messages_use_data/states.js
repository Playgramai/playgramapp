                ...
                "properties": {
                  "arbitrary_text": {
                    "entries": {
                      ...
                      "10": "] }, sort: [ { path: [\\\"sort\\\"], order: desc } ] ) { saved_manually saved_by_user_id user_message user_id file_url llm_reply sort chat_id _additional { id creationTimeUnix } } } }\"}\n"
                    },
                    "type": "TextExpression"
                  }
                },
                ...
                "properties": {
                  "arbitrary_text": {
                    "entries": {
                      ...
                      "6": ", where: {operator: And, operands: [{path:[\\\"vectorized_content\\\"], operator: IsNull, valueBoolean: false}, {operator: Or, operands: [{path:[\\\"memory_level_with_id\\\"], operator: ContainsAll, valueString:[\\\"team\\\"]}, {path:[\\\"memory_level_with_id\\\"], operator: ContainsAll, valueString:[\\\"",
                      "7": {
                        "next": {
                          "type": "Message",
                          "name": "_id",
                      ...
                      "10": "]}]}, sort: [ { path: [\\\"sort\\\"], order: desc } ]) {saved_manually sort saved_by_user_id user_message file_url user_id llm_reply chat_id _additional { id creationTimeUnix}} } }\"}\n"
                    },
                    "type": "TextExpression"
                  }
                },
                ...
                "properties": {
                  "arbitrary_text": {
                    "entries": {
                      ...
                      "8": "\\\" }, { path: [\\\"memory_level_with_id\\\"], operator: ContainsAll, valueString: [\\\"project\\\", \\\"",
                      "9": {
                        "next": {
                          "next": {
                            "type": "Message",
                      ...
                      "12": " ] }, sort: [ { path: [\\\"sort\\\"], order: desc } ] ) { saved_manually file_url sort saved_by_user_id user_message project_id user_id llm_reply chat_id _additional { id creationTimeUnix} } } }\"}\n"
                    },
                    "type": "TextExpression"
                  }
                },
                ...
                "properties": {
                  "arbitrary_text": {
                    "entries": {
                      ...
                      "8": " {path:[\\\"vectorized_content\\\"], operator: IsNull, valueBoolean: false}, {operator: Or, operands: [{path:[\\\"memory_level_with_id\\\"], operator: ContainsAll, valueString:[\\\"team\\\"]}, {path:[\\\"memory_level_with_id\\\"], operator: ContainsAll, valueString:[\\\"",
                      "9": {
                        "next": {
                          "type": "Message",
                          "name": "_id",
                      ...
                      "10": "\\\",\\\"personal\\\"]}, {operator: And, operands:[{operator: Or, operands:[{path:[\\\"project_id\\\"], operator: ContainsAny, valueString:[",
                      "11": {
                        "next": {
                          "next": {
                            "next": {
                      ...
                      "12": "]}, {path:[\\\"memory_level_with_id\\\"], operator: ContainsAny, valueString:[",
                      "13": {
                        "next": {
                          "next": {
                            "next": {
                      ...
                      "14": "]}]}]}]}]}, sort: [ { path: [\\\"sort\\\"], order: desc } ]) {saved_manually file_url sort saved_by_user_id user_message user_id llm_reply chat_id _additional { id creationTimeUnix}} } }\"}\n"
                    },
                    "type": "TextExpression"
                  }
                },
