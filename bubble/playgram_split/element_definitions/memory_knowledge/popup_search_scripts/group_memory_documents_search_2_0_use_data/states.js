  ...
  "0": {
    ...
    "properties": {
      "data_source": {
        ...
        "properties": {
          "provider": "apiconnector2.bTHIF0.bTiZW2",
          "body_params_text": {
            "entries": {
              "0": {
                "next": {
                ...
                "properties": {
                  "arbitrary_text": {
                    "entries": {
                      ...
                      "2": "\\\", where:{ operator:And, operands:[ { path:[\\\"uploaded_manually\\\"], operator:Equal, valueText:\\\"true\\\" }, { path:[\\\"project_id\\\"], operator:Equal, valueText:\\\"",
                      "3": {
                        "next": {
                          "next": {
                            "type": "Message",
                      ...
                      "4": "\\\" }, { path:[\\\"name\\\"], operator:Like, valueText:\\\"%",
                      "5": {
                        "next": {
                          "type": "Message",
                          "name": "get_data",
                      ...
                      "8": ", sort: [ { path: [\\\"sort\\\"], order: desc } ]) { file_url sort _additional { id creationTimeUnix } } } }\"}"
                    },
                    "type": "TextExpression"
                  }
                },
                ...
                "properties": {
                  "arbitrary_text": {
                    "entries": {
                      ...
                      "4": "\\\", where:{ operator:And, operands:[ { path:[\\\"uploaded_manually\\\"], operator:Equal, valueText:\\\"true\\\" }, { path:[\\\"name\\\"], operator:Like, valueText:\\\"%",
                      "5": {
                        "next": {
                          "type": "Message",
                          "name": "get_data",
                      ...
                      "6": "%\\\" }, { operator:Or, operands:[ { path:[\\\"organization_id\\\"], operator:Equal, valueText:\\\"",
                      "7": {
                        "next": {
                          "next": {
                            "type": "Message",
                      ...
                      "10": "\\\" }, { path:[\\\"project_id\\\"], operator:ContainsAny, valueString:[",
                      "11": {
                        "next": {
                          "next": {
                            "next": {
                      ...
                      "14": ", sort: [ { path: [\\\"sort\\\"], order: desc } ]) { file_url sort _additional { id creationTimeUnix } } } }\"}"
                    },
                    "type": "TextExpression"
                  }
                },
