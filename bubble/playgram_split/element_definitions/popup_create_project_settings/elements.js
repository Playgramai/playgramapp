import { Popup_Project_Settings } from './popup_project_settings/index.js';
import { GF_Search_Users } from './gf_search_users.js';

export const elements = {
  "bTJkj": Popup_Project_Settings,
  "bTJqH": GF_Search_Users,
  "bTYJq1": {
    "properties": {
      "height": 320,
      "left": 0,
                  ...
                  "next": {
                    "next": {
                      "args": {
                        "next": {
                          "next": {
                            "args": "hover btn-cancel-delete-project",
                            "type": "Message",
                            "name": "contains",
                            "is_slidable": false
                          },
                  ...
                  "next": {
                    "next": {
                      "args": {
                        "next": {
                          "next": {
                            "args": "hover btn-delete-delete-project",
                            "type": "Message",
                            "name": "contains",
                            "is_slidable": false
                          },
            ...
            "elements": {
              "bTItz0": {
                "properties": {
                  "text": {
                    "entries": {
                      "0": "Delete any memory saved during this project"
                    },
                    "type": "TextExpression"
                  },
                  "height": 36,
              ...
              "bTIuA0": {
                "properties": {
                  ...
                  "width": 280,
                  "zindex": 16,
                  "border_color": "rgba(112,112,114,1)",
                  "border_roundness": 4,
                  "vertical_centering": true,
